...
namespace SLH.Service.Common
{
    public class FileLogic
    {
        public static string CalculateMimeType(string extension)
        {
            ...
            var matchedMimeType1 = GetMimeType(extension);
            //if(matchedMimeType != null)
            //{
            //    //return matchedMimeType.Mimetype;
            //}

            if (matchedMimeType1 != null && new Regex("(video|image)").IsMatch(matchedMimeType1)) // (matchedMimeType1.Contains("video")|| matchedMimeType1.Contains("image"))
            {
                return matchedMimeType1;
            }
            else
            {
                return null;
        ...
        public static List<AcceptedMimetypes> GetAcceptedMimetypes()
        {
            List<AcceptedMimetypes> mimetypes = new List<AcceptedMimetypes>();

            mimetypes.Add(new AcceptedMimetypes
            {
                Extension = ".mp4",
                Mimetype = "video/mp4"
            });
